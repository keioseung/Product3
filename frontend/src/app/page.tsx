...
import { FaChartLine, FaArrowRight, FaCoins, FaPiggyBank, FaChartBar } from 'react-icons/fa'
...
export default function IntroPage() {
  ...
  const taglines = [
    "매일 새로운 금융 정보로 지식을 쌓아보세요",
    "실전 퀴즈로 학습한 내용을 점검하세요",
    "개인별 학습 진행률을 체계적으로 관리하세요",
    "금융 세계의 핵심 개념을 쉽게 이해하세요"
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-green-900/10 via-transparent to-emerald-900/10 animate-gradient-float" />
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-emerald-500/15 to-green-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-gradient-to-r from-green-500/10 to-yellow-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="absolute w-px h-32 bg-gradient-to-b from-transparent via-green-500/30 to-transparent animate-slide-down"
            style={{
              left: `${20 + i * 15}%`,
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <div className="flex flex-col items-center gap-8 mb-12">
            <div className="relative">
              <div className="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-r from-green-500 to-emerald-500 rounded-3xl flex items-center justify-center shadow-2xl animate-glow">
                <FaChartLine className="text-4xl md:text-5xl text-white" />
              </div>
              <div className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full animate-pulse" />
              {/* 빛나는 효과 */}
              <div className="absolute inset-0 bg-gradient-to-r from-green-500/30 to-emerald-500/30 rounded-3xl blur-xl animate-pulse" />
            </div>
            <div>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-white via-green-200 to-emerald-200 bg-clip-text text-transparent drop-shadow-2xl tracking-tight leading-tight mb-6 animate-text-glow">
                {typedText}
                {isTyping && <span className="animate-blink">|</span>}
              </h1>
              <div className="h-10 md:h-12">
                <p className="text-xl md:text-2xl lg:text-3xl text-green-300 font-medium animate-fade-in-out">
          ...
          <div className="text-center mb-12 md:mb-16 max-w-4xl mx-auto">
            ...
            <p className="text-white/70 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
              최신 금융 트렌드와 핵심 개념을 체계적으로 학습하고,<br />
          ...
          {/* CTA 버튼 */}
          <button
            className="group px-12 md:px-16 py-5 md:py-6 bg-gradient-to-r from-green-600 via-emerald-600 to-green-600 text-white text-xl md:text-2xl rounded-2xl font-bold shadow-2xl hover:from-green-700 hover:via-emerald-700 hover:to-green-700 transition-all flex items-center gap-4 mx-auto animate-fade-in hover:scale-105 active:scale-95 relative overflow-hidden animate-button-glow"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 w-full max-w-5xl mb-20">
          {[
            { 
              icon: FaCoins, 
              title: "금융 정보 학습", 
              desc: "매일 새로운 금융 정보를 제공합니다. 각 정보에는 관련 용어들이 포함되어 있어 금융 개념을 체계적으로 학습할 수 있습니다.", 
              color: "from-green-500 to-emerald-500"
            },
            { 
              icon: FaPiggyBank, 
              title: "용어 퀴즈", 
              desc: "학습한 금융 정보의 관련 용어들을 퀴즈로 점검합니다. 다양한 난이도의 문제로 지식 이해도를 확인하고 실력을 향상시켜보세요.", 
        ...
        <div className="grid grid-cols-3 gap-8 md:gap-12 w-full max-w-4xl">
          {[
            { label: "매일 새로운", value: "금융 정보", icon: FaCoins },
            { label: "핵심 개념", value: "관련 용어", icon: FaPiggyBank },
            { label: "지식 점검", value: "실전 퀴즈", icon: FaChartBar }
          ].map((stat, index) => (
            <div key={index} className="text-center animate-stat-fade-in" style={{ animationDelay: `${index * 0.3}s` }}>
              <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-2xl flex items-center justify-center mx-auto mb-3 animate-stat-glow">
                <stat.icon className="text-green-400 text-xl md:text-2xl" />
              </div>
